...
public class SearchKeyWords extends SearchEngine {
	...
	/**
	 * version 2 This function will take a list of urls and pull ALL of the
	 ...
	 */
	public String[][] ScrapeWords(String[] listOfUrls) 
		{
				...
				for(int i = 0; i < listOfUrls.length; i++)
					{
						...
						boolean check = super.readWebPage();
						...
						for(int j = 0; j < 10; j++)
							{
								String[] currentUrlAndWord = {doc.
								allUrlsAndWordsList.add(listOfUrls[i]);
	...
	public static void main(String[] args) {
		SearchKeyWords testSearch = new SearchKeyWords(
				"http://www.colorado.gov");
		String[] urls = { "http://www.colorado.gov" };
		testSearch.ScrapeWords(urls);

		// SearchKeyWords search = new
		// SearchKeyWords("http://www.pageinc.org/");
