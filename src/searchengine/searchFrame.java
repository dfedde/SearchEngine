...
public class searchFrame extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		resultsPane.setCursor(new java.awt.Cursor(
		...
		layout.setHorizontalGroup(layout
				...
				.addGroup(
						layout.createSequentialGroup()
								...
								.addComponent(goButton).addContainerGap())
	...
	private void goButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_goButtonActionPerformed
		SearchLinks linkSearcher = new SearchLinks(
				"http://www.kbuxton.com/discordia/fnord.html");
		SearchKeyWords pageSearcher = new SearchKeyWords(
				"http://www.kbuxton.com/discordia/fnord.html");
		String html;
		List<String[]> results;
